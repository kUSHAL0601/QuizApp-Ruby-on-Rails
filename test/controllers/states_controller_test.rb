...
class StatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create state" do
    assert_difference('State.count') do
      post states_url, params: { state: { genre: @state.genre, qsnid: @state.qsnid, score: @state.score, subgenre: @state.subgenre, userid: @state.userid } }
    end
  ...
  test "should update state" do
    patch state_url(@state), params: { state: { genre: @state.genre, qsnid: @state.qsnid, score: @state.score, subgenre: @state.subgenre, userid: @state.userid } }
